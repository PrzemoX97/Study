...
import com.demo.dto.demo.dto.dto.CountDto;
...
public class Controller {
    ...
    public ResponseEntity<CountDto> getMean(@RequestParam (value = "text", required = false) String text,
